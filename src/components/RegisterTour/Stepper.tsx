...
export default function Stepper() {
  ...
  const steps = [
...

    {
      ...
      content: (
        <>
          <p>Revise su información antes de subirla</p>
      ...
      <div className='flex mb-6'>
        ...
        <div className='flex-1 w-full'>
          ...
          <button
            ...
            className='px-4 py-2 mr-[55vw] text-base border-none rounded bg-secondary text-gray-800 cursor-pointer disabled:bg-[#999999] disabled:cursor-not-allowed'
          >
            Back
          </button>
          <button
